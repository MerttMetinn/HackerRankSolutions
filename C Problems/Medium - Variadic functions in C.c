...
int test_implementations_by_sending_three_elements() {
    ...
    fprintf(stderr, Sending following three elementsn);
    for (int i = 0; i  3; i++) {
        fprintf(stderr, %dn, elements[i]);
    }
    ...
    fprintf(stderr, Your output isn);
    fprintf(stderr, Elements sum is %dn, elements_sum);
    fprintf(stderr, Minimum element is %dn, minimum_element);
    fprintf(stderr, Maximum element is %dnn, maximum_element);
...
int test_implementations_by_sending_five_elements() {
    ...
    fprintf(stderr, Sending following five elementsn);
    for (int i = 0; i  5; i++) {
        fprintf(stderr, %dn, elements[i]);
    }
...
int test_implementations_by_sending_ten_elements() {
    ...
    fprintf(stderr, Sending following ten elementsn);
    for (int i = 0; i  10; i++) {
        fprintf(stderr, %dn, elements[i]);
    }
